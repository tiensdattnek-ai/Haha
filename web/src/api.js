...
export const api = {
  ...
  webStatus: () => fetch('/api/web/status').then(json),
  webSearch: (query, opts = {}) => fetch('/api/web/search', { method: 'POST', headers: { 'content-type': 'application/json' }, body: JSON.stringify({ query, ...opts }) }).then(json),
